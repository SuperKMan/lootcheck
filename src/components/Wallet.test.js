...
describe("Wallet", () => {
  ...
  it("should creates an input to deposit into or withdraw from the balance", () => {
  ...
  describe("when user types into the wallet input", () => {
    ...
    it("should updates the local wallet balance in `state` and converts it to a number", () => {
